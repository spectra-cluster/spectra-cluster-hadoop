...
public class ConfigurableProperties {
    ...
    public static void appendAnalysisParameters(@Nonnull Appendable out) {
        try {
            ...
            out.append("sameClusterMergeMZWindowSize=").append(Util.formatDouble(HadoopDefaults.getSameClusterMergeMZWindowSize(), 3)).append("\n");
            out.append("majorPeakMZWindowSize=").append(Util.formatDouble(HadoopDefaults.getMajorPeakMZWindowSize(), 3)).append("\n");
            out.append("spectrumMergeMZWindowSize=").append(Util.formatDouble(HadoopDefaults.getSpectrumMergeMZWindowSize(), 3)).append("\n");
