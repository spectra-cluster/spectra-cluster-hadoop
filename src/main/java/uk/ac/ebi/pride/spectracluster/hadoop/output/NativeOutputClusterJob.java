...
import uk.ac.ebi.pride.spectracluster.hadoop.io.ClusteringFileOutputFormat;
import uk.ac.ebi.pride.spectracluster.hadoop.util.HadoopUtilities;

/**
 * Job to output cluster into .clustering file using hadoop native
 * output mechanism
 *
 * @author Steve Lewis
 * @author Rui Wang
 * @version $Id$
 */
public class NativeOutputClusterJob extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        // output format
        job.setOutputFormatClass(ClusteringFileOutputFormat.class);

        // set mapper, reducer and partitioner
        job.setMapperClass(MZKeyMapper.class);
        job.setReducerClass(ClusteringFileWriteReducer.class);
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new NativeOutputClusterJob(), args);
